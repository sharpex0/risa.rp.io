...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    window.addEventListener("load", function () {
      // Sayfa tamamen yüklendiğinde loading ekranını kaldır
      loadingScreen.classList.remove("show");
    });

    // İstediğiniz bir görevin tamamlanması durumunda loading ekranını kaldırabilirsiniz
    // Örneğin, giriş işlemi başarıyla tamamlandığında:
    // yourLoginFunction().then(function() {
    //   loadingScreen.classList.remove("show");
    // });
  });
</script>
